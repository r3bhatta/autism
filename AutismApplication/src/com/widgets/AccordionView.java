...
public class AccordionView extends LinearLayout {
    ...
    public AccordionView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            headerFoldButton = a.getResourceId(R.styleable.accordion_header_layout_fold_button_id,
                    0);
            ...
            int sectionHeadersResourceId = a
                    .getResourceId(R.styleable.accordion_section_headers, 0);
    ...
    private View getView(final LayoutInflater inflater, int i, boolean hide) {
        ...
        container.setLayoutParams(new ListView.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
