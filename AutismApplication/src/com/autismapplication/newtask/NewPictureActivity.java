...
import com.autismapplication.R.string;
...
public class NewPictureActivity extends Activity {
    ...
    private void handleCameraPhoto() {
        ...
        if (mCurrentPhotoPath != null) {
            ...
            NewTaskActivity.picturesContainerList.add(pictureLocation);
            galleryAddPic();
            mCurrentPhotoPath = null;
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isIntentAvailable(this, MediaStore.ACTION_IMAGE_CAPTURE))
        {
            ...
            Toast.makeText(getApplicationContext(), "Your device does not support taking pictures",
